...
fun NotezApp() {
    ...
    val pagesWithoutBottomBars =  listOf("loginPage", "signupPage", "introPage", "profile", "viewPastYearPaper/{paperId}","chatbot","viewPdfPage/{encodedUrl}")
    val pagesWithoutChatButton =  listOf("loginPage", "signupPage", "introPage", "chatbot", "upload")
