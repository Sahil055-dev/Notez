...
import com.example.notez.database.HomeViewModel
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(text = "Hello ${name.value}!", fontWeight = FontWeight.Bold, fontSize = 18.sp)
                    Text(text = email.value, fontWeight = FontWeight.Normal, fontSize = 16.sp, color = Tertiary)
                }
            }
